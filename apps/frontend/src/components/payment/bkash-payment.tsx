          ...
          <div className="bg-[#E2136E] px-6 py-4 text-white">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-lg">bKash Payment</h2>
              ...
              {step === "phone" && (
                ...
                >
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 text-center">
                    ...
                    <p className="text-3xl font-bold text-[#E2136E]">৳ {amount}</p>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-10 h-12 text-lg border-gray-200 focus:border-[#E2136E] focus:ring-[#E2136E]"
                      />
                    </div>
                  ...
                  <div className="space-y-3">
                    <Button
                      ...
                      disabled={loading}
                      className="w-full h-12 bg-[#E2136E] hover:bg-[#C0105E] text-white font-semibold rounded-xl"
                    >
                      {loading ? (
              ...
              {step === "otp" && (
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="font-semibold text-[#E2136E]">{phoneNumber}</p>
                    {demoOtp && (
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="h-14 text-center text-2xl tracking-[1em] font-bold border-gray-200 focus:border-[#E2136E] focus:ring-[#E2136E]"
                      maxLength={6}
                    />
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      disabled={loading}
                      className="w-full text-[#E2136E] hover:text-[#C0105E]"
                    >
                      Resend OTP
                    </Button>
                  </div>
              ...
              {step === "success" && (
                ...
                >
                  ...
                  <p className="text-gray-500 mb-4">
                    ৳ {amount} has been paid via bKash
                  </p>
